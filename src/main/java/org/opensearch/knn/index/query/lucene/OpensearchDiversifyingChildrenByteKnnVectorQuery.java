...
@Getter
public class OpensearchDiversifyingChildrenByteKnnVectorQuery extends DiversifyingChildrenByteKnnVectorQuery {

    private final int kCandidates;

    public OpensearchDiversifyingChildrenByteKnnVectorQuery(
        final String field,
        final byte[] query,
    ...
    public boolean equals(Object o) {
        ...
        OpensearchDiversifyingChildrenByteKnnVectorQuery that = (OpensearchDiversifyingChildrenByteKnnVectorQuery) o;
