...
public class KNNMergeVectorValuesUtilTests extends KNNTestCase {
    ...
    @Mock
    private BitSet fixedBitSetLiveDocs;
    @Mock
    ...
    public void testFloatMergeVectorValues() {
        ...
        when(fixedBitsLiveDocs.get(anyInt())).thenReturn(true);
        when(fixedBitSetLiveDocs.get(anyInt())).thenReturn(true);

        final MergeState mergeState = mergeState(knnVectorsReaders, liveDocs, docMaps);

        // When
        FloatVectorValues iterator = KNNMergeVectorValuesUtil.mergeFloatVectorValues(fieldInfo, mergeState);
    ...
    public void testByteMergeVectorValues() {
        ...
        // When
        ByteVectorValues iterator = KNNMergeVectorValuesUtil.mergeByteVectorValues(fieldInfo, mergeState);
